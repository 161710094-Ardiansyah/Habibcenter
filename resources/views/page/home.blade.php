    ...
    <div class="fbq-main fbq-main--single">
      <div class="fbq-main-wrapper">
        <div id="beranda" class="fbq-section js-dynamic-navbar fbq-p-border-border fbq-dark-scheme" data-index="0" data-scheme="dark">
          <div class="fbq-background fbq-background--fixed" data-type="image" data-parallaxspeed="0">
            <div class="fbq-background-wrapper">
              <div class="fbq-background-inner" style="background-image:url('{{asset('assets/images/1.jpg')}}'); background-size:cover; background-position:center top; background-repeat:no-repeat;"></div>
            </div>
            ...
            <div class="fbq-container">
              <div class="fbq-row fbq-row--main fbq-row--40">
                <div class="fbq-col-5">
                            ...
                            <div class="fbq-image-container">
                              <div class="fbq-media-wrapper with-placeholder" >
                                <div class="fbq-media-wrapper-inner">
                                  ...
                                  <img alt="" title="Habib Center" width="600" height="200" data-full-width="600" data-full-height="200" data-sizes="(max-width:600px) 100vw, 600px" data-src="{{asset('assets/images/bb.jpg')}}"  src="{{asset('assets/images/bb.jpg')}}" class="fbq-media-wrapper-image image-lazy-load"  />
                                </div>
                              </div>
                            </div>
                          </div>
                                    ...
                                    <div class="fbq-box-content fbq-middle-vertical" style="overflow-y:hidden;">
                                      <div class="fbq-box-body" style="padding-top:10px; padding-bottom:10px;">
                                        <div class="fbq-item js-item-image fbq-image fbq-center-align" >
                                          <div class="fbq-image-container">
                                            <div class="fbq-media-wrapper with-placeholder" >
                                              <a class="fbq-media-wrapper-inner"  target="_self">
                                                <div class="media-placeholder" style="width:1024px; padding-bottom:100%;"></div>
                                                <img alt="" title="Habib Center" width="1024" height="1024" data-full-width="1024" data-full-height="1024" data-sizes="(max-width:1024px) 100vw, 1024px" data-src="{{asset('assets/images/cc.jpg')}}" src="{{asset('assets/images/cc.jpg')}}" class="fbq-media-wrapper-image image-lazy-load"  />
                                              </a>
                                            </div>
                                          </div>
                                        </div>
                                        ...
                                        <div class="fbq-item js-item-image fbq-image fbq-center-align" >
                                          <div class="fbq-image-container">
                                            <div class="fbq-media-wrapper with-placeholder" >
                                              <a class="fbq-media-wrapper-inner"  target="_self">
                                                <div class="media-placeholder" style="width:1024px; padding-bottom:100%;"></div>
                                                <img alt="" title="Habib Center" width="1024" height="1024" data-full-width="1024" data-full-height="1024" data-sizes="(max-width:1024px) 100vw, 1024px" data-src="{{asset('assets/images/ff.jpg')}}" src="{{asset('assets/images/ff.jpg')}}" class="fbq-media-wrapper-image image-lazy-load"  />
                                              </a>
                                            </div>
                                          </div>
                                        </div>
                  ...
                  <div id="accordion-landing" class="fbq-item js-item-accordion fbq-accordion fbq-accordion--fill fbq-left-align fbq-force-center-mobile anmt-item anmt-fadeinl minimal-plus" data-style="fill">
                    ...
                    <div class="fbq-accordion-panel fbq-p-border-border"  data-index="{{$data->id}}">
                      <a href="#" class="fbq-accordion-heading fbq-p-text-color" style="background-color:#e3e3e3;" data-index="{{$data->id}}">
                      <span class="fbq-accordion-title fbq-secondary-font">Jadwal Kegiatan Habib Syarief Muhammad Minggu ini</span>
                      </a>
                      <div class="fbq-accordion-body fbq-side-padding" style="padding-top:20px;" data-index="{{$data->id}}">
                        <div class="fbq-background" data-type="image" data-parallaxspeed="0">
                          <div class="fbq-background-wrapper">
                            <div class="fbq-background-inner" style="background-image:url('{{asset('assets/images/poly-bg.jpg')}}'); background-size:cover; background-position:center center; background-repeat:repeat;"></div>
                          </div>
                          ...
                          <div class="fbq-item js-item-video fbq-video fbq-video--standard fbq-center-align" style="padding-top:8px;" >
                            <div class="fbq-video-inner" style="max-width:1280px;">
                              <div class="fbq-video-content" >
                                <iframe width="560" height="315" src="https://www.youtube.com/embed/_mDTGOQmcAs" frameborder="0" allow="autoplay; encrypted-media" allowfullscreen></iframe>      
                              </div>
                            </div>
                          </div>
                        </div>
              ...
              <div class="fbq-row fbq-row--main">
               ...
               <div class="fbq-row fbq-row--main">
                <div class="fbq-col-12">
                  <div id="home-post" class="fbq-item js-item-blog fbq-blog fbq-blog--plain fbq-left-align fbq-entries fbq-entries--grid fbq-entries--plain medium"  data-style="plain" data-layout="grid">
                    <center><h3 class="fbq-heading-text fbq-secondary-font fbq-p-border-border fbq-s-text-color" > Instagram</h3></center><br>
                    <div class="fbq-entries-content" style="margin:0 -15px;">
                      @for($i=0; $i < count($results); $i++)
                      <article class="fbq-entry fbq-col-3 post-2502 post type-post status-publish format-standard has-post-thumbnail hentry category-aktual category-artikel category-jabar-juara tag-jabar-juara tag-jawa-barat tag-pilkada tag-ridwan-kamil tag-rindu tag-uu-ruzhanul-ulum" style="margin-bottom:30px; padding:0 15px;">
                        <div class="fbq-entry-inner fbq-p-border-border anmt-item anmt-fadeinu">
                          <div class="fbq-entry-header" >
                            <div class="fbq-media-wrapper with-placeholder anmt-image-slowzoom" >
                              <a class="fbq-media-wrapper-inner" href="{{ $results[$i]->link}}"  target="_blank">
                                <div class="media-placeholder" style="width:768px; padding-bottom:56.25%;"></div>
                                <img alt="" title="" width="768" height="512" data-full-width="2016" data-full-height="1344" src="{{ $results[$i]->images->standard_resolution->url }}" class="fbq-media-wrapper-image image-lazy-load"  />
                              </a>
                            </div>
                          </div>
                        </div>
          ...
          <div class="fbq-background fbq-background--fixed" data-type="video" data-parallaxspeed="0">
            <div class="fbq-background-wrapper" style="background-image:url('{{asset('/img/'.$content->background)}}'); background-size:cover; background-position:center top; background-repeat:repeat;">
              ...
              <div class="fbq-background-wrapper-inner">
               <!--  <iframe class="fbq-video-background-inner fbq-video-background-inner--selfhosted"
                src="https://www.youtube.com/embed/XGSy3_Czz8k?autoplay=1&loop=1" frameborder="01">
                </iframe> -->
                <iframe class="fbq-video-background-inner fbq-video-background-inner--selfhosted" src="http://www.youtube.com/embed/{{$content->unique_url}}?autoplay=1&showinfo=0&controls=0&mute=1" frameborder="0" allowfullscreen></iframe>
              ...
              <div class="fbq-row fbq-row--main">
                ...
                <div class="fbq-col-8">
                  ...
                  <div class="fbq-heading fbq-heading--plain fbq-item js-item-heading fbq-heading fbq-heading--plain fbq-center-align anmt-item anmt-fadeinu">
                    <div class="fbq-heading-inner">
                      <h2 class="fbq-heading-text fbq-secondary-font fbq-p-border-border fbq-s-text-color" ><span style="color: rgb(255, 255, 255);">{!!$content->footer!!}</span></h2>
                    </div>
                  </div>
                  <div id="cta-parallax" class="fbq-item js-item-box fbq-box fbq-center-align fbq-p-border-border" >
                    ...
                    <div class="fbq-item js-item-social fbq-social fbq-social--border fbq-center-align" data-style="border">
                      <div class="fbq-social-inner">
                        <a href="https://www.facebook.com/HabibCenter.2019/" class="fbq-social-item fbq-social-facebook" target="_blank"><span class="fbq-icon fbq-icon--border fbq-icon--small fbq-icon--with-hover fbq-icon--hover-plain"><span class="fbq-icon-normal fbq-icon-border fbq-p-brand-color" style="color:#ffffff;"><i class="twf twf-facebook"></i></span><span class="fbq-icon-hover fbq-icon-plain fbq-s-brand-color" style="color:#e3a700;"><i class="twf twf-facebook"></i></span></span></a><a href="https://www.instagram.com/habibcenter" class="fbq-social-item fbq-social-instagram" target="_blank"><span class="fbq-icon fbq-icon--border fbq-icon--small fbq-icon--with-hover fbq-icon--hover-plain"><span class="fbq-icon-normal fbq-icon-border fbq-p-brand-color" style="color:#ffffff;"><i class="twf twf-instagram"></i></span><span class="fbq-icon-hover fbq-icon-plain fbq-s-brand-color" style="color:#e3a700;"><i class="twf twf-instagram"></i></span></span></a><a href="https://www.youtube.com/user/syariefassalaam" class="fbq-social-item fbq-social-youtube" target="_blank"><span class="fbq-icon fbq-icon--border fbq-icon--small fbq-icon--with-hover fbq-icon--hover-plain"><span class="fbq-icon-normal fbq-icon-border fbq-p-brand-color" style="color:#ffffff;"><i class="twf twf-youtube"></i></span><span class="fbq-icon-hover fbq-icon-plain fbq-s-brand-color" style="color:#e3a700;"><i class="twf twf-youtube"></i></span></span></a>  
                      </div>
                    </div>
                  </div>
                </div>
...
s1.async=true;
s1.src='https://embed.tawk.to/5bb704fcb033e9743d02663d/default';
s1.charset='UTF-8';
